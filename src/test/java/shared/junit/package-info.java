 ...
 * </p>
 * <p>
 * Unit shared tests are classes that can automatically be executed by a
 * testing framework. Each unit test class can have multiple test cases and
 * each such test case checks whether one particular method or interaction
 * of a tested class behaves as it should behave. For example, one could
 * test the {@link java.lang.String#concat(java.lang.String)} method by
 * creating two strings {@code a} and {@code b} and checking whether a
