...
/** The test for data clustering based on example data. */
@Ignore
public abstract class ExampleBasedDataClustererTest
    extends DataClustererTestBasedOnExampleData {
   ...
   *          the clusterer
   */
  public ExampleBasedDataClustererTest(final IDataClusterer clusterer) {
    super(clusterer);
  }
